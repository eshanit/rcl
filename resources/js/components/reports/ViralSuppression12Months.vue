...
<template>
    <h4 class="text-md font-medium mb-3">Viral Suppression at 12 Months</h4>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div class="bg-white p-4 rounded-lg border border-gray-200">
            ...
            <p class="text-sm">11-13 months after ART initiation</p>
            <p class="text-sm">Closest test to 12 months used</p>
        </div>
        <div class="bg-white p-4 rounded-lg border border-gray-200">
    ...
    <div class="mt-4 bg-blue-50 p-3 rounded-lg border border-blue-200">
        <p class="text-sm text-blue-700">
            ...
            who received a viral load test within the 11-13 month window.
        </p>
    </div>
</template>