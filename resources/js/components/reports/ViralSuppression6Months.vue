...
<template>
    <h4 class="text-md font-medium mb-3">Viral Suppression at 6 Months</h4>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div class="bg-white p-4 rounded-lg border border-gray-200">
            ...
            <p class="text-sm">5-7 months after ART initiation</p>
            <p class="text-sm">Closest test to 6 months used</p>
        </div>
        <div class="bg-white p-4 rounded-lg border border-gray-200">
            <h5 class="font-medium mb-2">Eligibility Criteria</h5>
            <p class="text-sm">Patients initiated ART at least 7 months ago</p>
    ...
    <div class="mt-4 bg-blue-50 p-3 rounded-lg border border-blue-200">
        <p class="text-sm text-blue-700">
            ...
            who received a viral load test within the 5-7 month window.
        </p>
    </div>
</template>